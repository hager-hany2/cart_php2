                ...
                <?php
                    ...
                    <tbody>'; 
                        ...
                        ?>
                            ...
                            <td><?php echo $row['price']?><input style="width: 25%; margin-top: 12px;" class="form-control" placeholder=" Quantity" name="=Quantity-product" type="number" min="0" required="" fdprocessedid="cz881s"></td>

                            <td>
                            
                            <a href="deletecart.php?deletecart=<?php echo $row['ID']?>"class="text-danger" onclick="return confirm('Are you sure delete this?')" >
                    ...
                    <!-- <div class="card">
                    <img style="width: 100px; height:100px" src="<?php echo$row['image']?>" alt="<?php echo $row['name'];?>">
