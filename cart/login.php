...
<div class="login"style="margin-top: 5%; position:relative;z-index:20;"> 
            ...
            <div class="card-body">
                <h3 class="card-title text-center" style=" color: #303030d9;font-weight: bolder;">Login</h3>
                <?php 
        if(isset($data_check)){
            if($data_check ==false){
        ...
        <form action="" method="post" style="max-width:500px" class="m-auto">
            ...
            <div class="mb-3">
                ...
                <a href="sigin.php" class="text-warning" style="margin-top: 16px;text-decoration: none;">I don't have an account</a>
            </div>
